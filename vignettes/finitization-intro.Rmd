...
The `finitization` package is available through the `R-universe repository`, which provides precompiled binaries for all major operating systems — Windows, Linux, and macOS (both x86_64 and arm64 architectures).
