# tools/winlibs.R
# Download prebuilt Windows (UCRT) / linux libs for GMP, CLN, GiNaC into ./windows/ucrt64/ or ./linux/x86_64
# Executed automatically by Windows / Linux builders (e.g., r-universe). CRAN ignores it
...
if (.Platform$OS.type == "windows") {
    ...
    bundle_name <- sprintf("finitization-%s-gmp+cln+ginac-static.zip", plat)
