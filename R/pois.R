...
#' @param theta The mean parameter of the finitized Poisson distribution.
...
#' @param lower.tail Logical; if \code{TRUE} (default), probabilities are calculated as \eqn{P(X \le x)}.
